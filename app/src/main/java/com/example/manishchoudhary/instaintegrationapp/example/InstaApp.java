...
import com.example.manishchoudhary.instaintegrationapp.example.InstaDialog.OAuthDialogListener;
import com.example.manishchoudhary.instaintegrationapp.loads.Utils;
...
public class InstaApp {
    ...
    public InstaApp(Context context, String clientId, String clientSecret,
                        String callbackUrl) {

        mClientId = clientId;
        mClientSecret = clientSecret;
        mCtx = context;
        mSession = new InstaSession(context);
        ...
        mDialog = new InstaDialog(context, mAuthUrl, listener);
