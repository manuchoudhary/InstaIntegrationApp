package com.example.manishchoudhary.instaintegrationapp.example;
...
import com.example.manishchoudhary.instaintegrationapp.R;
import com.example.manishchoudhary.instaintegrationapp.example.InstaApp.OAuthAuthenticationListener;
import com.example.manishchoudhary.instaintegrationapp.loads.ImageLoader;

public class MainActivity extends Activity implements OnClickListener {

    private InstaApp mApp;
    ...
    private Handler handler = new Handler(new Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (msg.what == InstaApp.WHAT_FINALIZE) {
                userInfoHashmap = mApp.getUserInfo();
            } else if (msg.what == InstaApp.WHAT_FINALIZE) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mApp = new InstaApp(this, ApplicationData.CLIENT_ID,
        ...
        if (v == btnConnect) {
            ...
            if (v == btnFollowers) {
                url = "https://api.instagram.com/v1/users/"
                        + userInfoHashmap.get(InstaApp.TAG_ID)
    ...
    private void displayInfoDialogView() {
        ...
        new ImageLoader(MainActivity.this).DisplayImage(
                userInfoHashmap.get(InstaApp.TAG_PROFILE_PICTURE),
                ivProfile);
        tvName.setText(userInfoHashmap.get(InstaApp.TAG_USERNAME));
        tvNoOfFollowing.setText(userInfoHashmap.get(InstaApp.TAG_FOLLOWS));
        tvNoOfFollwers.setText(userInfoHashmap
                .get(InstaApp.TAG_FOLLOWED_BY));
